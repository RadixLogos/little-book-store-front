...
export class Menu {
  ...
  activeScreen: 'books' | 'register' | 'sell' | 'clientSelector' | 'clientRegister' | 'buyOrders' = 'books';
  ...
  openScreen(screen: 'books' | 'register' | 'sell' | 'clientSelector' | 'clientRegister' | 'buyOrders') {
